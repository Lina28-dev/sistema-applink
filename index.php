<?php
// Process POST actions before any output to allow header redirects
...
// Now include header (will output HTML)
include 'header.php';
  ...
  <?php
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="col-md-3 col-sm-6 col-6">
              <div>
                <img src="admin/product_img/<?php echo $row['imgname']; ?>" class="product-img img-fluid" >
              </div>
              <div>
              <div>
